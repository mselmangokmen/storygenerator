...
from dataset_loader_files.story_train_data_loader import PrepareStoriesForGPT2
...
def train_model(model, optimizer, scheduler,train_dataloader, valid_dataloader,train_batch_size,valid_batch_size, device): 
    ...
    torch.save(model.state_dict(), "pretrained_models/gpt2_complete_story.pt")
...
dataset_prep= PrepareStoriesForGPT2( batch_size=train_batch_size)
